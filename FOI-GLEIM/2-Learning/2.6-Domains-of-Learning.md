...
2) The **Cognitive Domain (thinking)** deals with mental activity and knowledge (e.g. facts, concepts, or relationships).
    ...
    - The **lowest** level is <a style="color:inherit;text-decoration:none;" id="rote-learning">**rote learning**</a>, which is the ability to just repeat back what has been taught, without necessarily understanding or being able to apply what has been learned.
